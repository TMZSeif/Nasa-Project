...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Asteroid Impact Simulator - NASA Space Apps Challenge 2025</p>
        </header>
            ...
            <div class="controls-row">
                ...
                <div class="control-group">
                    <label>
                        ...
                        <span class="tooltip">
                            <span class="tooltip-icon">?</span>
                            <span class="tooltip-text">Major metropolitan areas selected to demonstrate potential impact scenarios on densely populated regions</span>
                        </span>
                    </label>
